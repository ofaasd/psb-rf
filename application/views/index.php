                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="user-profile header-notification">
                            <div class="dropdown-primary dropdown">
                                <div class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url();?>/assets/images/logo/logo.png" class="img-radius" alt="User-Profile-Image">
                                    <span><?php echo $this->authact->get_nama()?></span>
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="<?php echo $dmenu->url=='#'?'#':base_url(),$dmenu->url?>">
                                            <span class="pcoded-micon"><i class="<?php echo $dmenu->icon?>"></i></span>
                                            <span class="pcoded-mtext"><?php echo $dmenu->nama_menu?></span>

                                        </a>
                                        <ul class="pcoded-submenu">
                                            <?php
                                                $c=$this->Model_front->getSubMenu($dmenu->id,$this->authact->getRole());
                                                $ch = $c->result();
                                                foreach($ch as $item)
                                                {
                                            ?>
                                            <li class="">
                                                <a href="<?php echo base_url(),$item->url?>">
                                                    <span class="pcoded-mtext"><?php echo $item->nama_menu?></span>
