                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <form action="<?php echo base_url()?>pmb/pmb/surat_pengumuman" method="post">
                                                    ...
                                                    <?php foreach($registrasi as $d){?>
                                                     <div class="form-group row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <?php $spi = 0; $sks=0; if($d->kelas == 1){ $spi = 7500000; $sks = 2900000;}else{ $spi = 9500000; $sks = 3100000;}?>
                                                                <input hidden="" name="spi" value="<?php echo $spi; ?>"></input>
                                                                <p><?php echo rupiah($spi); ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="col-sm-6">
                                                                <label><b>Satuan Kredit Semester (SKS) :</b></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <input hidden="" name="sks" value="<?php echo $sks; ?>"></input>
                                                                <p><?php echo rupiah($sks); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6">
                                                            <?php if($d->jalur_pendaftaran == 3){?>
                                                                <div class="col-sm-6">
                                                                    <label><b>Nilai Tes Masuk (0-100) :</b></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <input type="number" name="tes" class="form-control" max="100" min="0" placeholder="0" required=""></input>
                                                                </div>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                            <label class="col-sm-9 col-form-label"></label>
                                                             <div class="col-sm-3">
                                                                <input type="submit" class="btn btn-success btn-round" value="Cetak Pengumuman">
                                                            </div>
                                                    </div>
                                                   </form>
                                                <?php } ?>
