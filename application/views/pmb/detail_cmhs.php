                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <h4 class="sub-title">DATA CALON MAHASISWA</h4>
                                                     <form action="<?php echo base_url()?>pmb/update_detail" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <label class="col-sm-4 col-form-label">Pilih Jenis Kelas :</label>
                                                             ...
                                                             <div class="col-sm-8">
                                                                <select name="jalur" class="form-control" readonly="">
                                                                    <option value="<?php echo $d->jalur_pendaftaran ?>" selected="" readonly=""><?php if($d->jalur_pendaftaran == 1){ echo "PMDP"; }else if($d->kelas == 2){ echo "KERJASAMA"; }else if($d->kelas == 3){ echo "UMUM"; }?></option>
                                                                </select>
                                                             </div>
