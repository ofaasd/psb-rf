...
<div class="page-body">
    <div class="row">
        <div class="col-sm-12">
            <form action="<?php echo base_url()?>pegawai/save" method="post" enctype="multipart/form-data">
            <div class="card">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <label class="col-sm-10 col-form-label">Nomor Induk pegawai(NIP): </label>
                        <div class="col-sm-10">
                            <!-- <input type="text" class="form-control" name="nip" id="nip" readonly> -->
                            <div class="input-group">
                                <div class="input-group-prepend">
                                  <span class="input-group-text" id="initial_nip">@</span>
                                </div>
                                <input type="text" class="form-control" id="nip" aria-describedby="inputGroupPrepend" required>
                            </div>
                        </div>
                        ...
                        <!-- 
                        <label class="col-sm-4 col-form-label">NIP PNS : </label>
                        <div class="col-sm-10">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="jurusan[]" value="" id="jurusans1" placeholder="Jurusan Ex : Teknik informatika">
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#status_pegawai").change(function(){
            ...
            var initial_nip = status+tgl;
            var nip = id;
            $("#initial_nip").html(initial_nip);
            $("#nip").val(nip);
