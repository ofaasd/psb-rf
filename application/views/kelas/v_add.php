                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card">
                                                  ...
                                                  <form action="<?php echo base_url();?>master/kelas/add_act" method="post">
                                                    <div class="col-sm-12">
                                                    <div class="col-sm-6">
                                                        Nama Kelas :
                                                        <p><input type="text" class="form-control" placeholder="Nama Kelas" name="nama" required=""></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                      Jalur Kelas :
                                                      <p>
                                                        <select name="jalur" class="form-control">
                                                            <option selected="" disabled="">--Jalur Kelas--</option>
                                                            <option value="1">PMDP, Umum, Kerjasama</option>
                                                            <option value="2">Umum, Kerjasama</option>
                                                        </select>
                                                      </p>
                                                    </div>
                                                    <div class="col-sm-6">
