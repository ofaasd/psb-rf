                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <?=$this->session->flashdata('matkul_kurikulum');?>
                                                        <div class="dt-responsive table-responsive">
                                                            <form action=<?=base_url('master/kurikulum/update_matkul_kurikulum')?> method=post>
                                                            ...
                                                            foreach($matakuliah as $a){?>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="checkbox" name="matkul[]" value="<?=$a->id?>"
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <th width="20px"></th>
                                                                    <th></th>
                                                                    <th width="10px"><input type="submit" class="btn btn-primary" value="Update"></th>
