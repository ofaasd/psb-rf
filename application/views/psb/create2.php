...
<div class="card-block">
	<div class="row">
		<div class="col-md-12">
			...
			<h2 style="margin:20px 5px;padding:0;">Form Pendaftaran Santri Baru</h2>
			<?php if(!empty($this->session->flashdata('error'))){?>
				<div class="alert alert-danger bg-danger text-white"><?=$this->session->flashdata('error')?></div>
			<?php } ?>
			<div id="wizard">
				<section>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="row" style="margin-top:10px;">
											<div class="form-check col-md-3" style="padding-left:35px;">
			...
			onFinished: function(event, currentIndex) {
					...
					$.ajax({
						...
						success: function(data){
							...
							localStorage.setItem("msg", data.pesan);
