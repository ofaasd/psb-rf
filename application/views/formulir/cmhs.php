			...
			<?php foreach($detail_cmhs as $d){ ?>
				PILIH KELAS :
					<p><select id="kelas" name="kelas" class="form-control" required="" disabled>
						...
						PILIH JALUR :
					<p><select id="jalur" name="jalur" class="form-control"  required="" disabled>
						...
						<div id="kerdiv" hidden="">
							...
							<p><select id="kerjasama" name="kerjasama" class="form-control" disabled>
								</select></p>
						</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" value="<?php echo $d->id ?>" name="id" hidden="" disabled>
							<input type="number" class="form-control" readonly="" name="nopen" value="<?php echo $d->nopen ?>"  maxlength="16" disabled>
						</div>
						<div class="col-sm-4">
							<label>Nomor KTP : </label>
						</div>
						<div class="col-sm-8">
							<input type="number" class="form-control" name="noktp" value="<?php echo $d->noktp ?>" maxlength="16" disabled>
						</div>
						<label class="col-sm-4 col-form-label">NISN : </label>
						<div class="col-sm-8">
							<input type="number" class="form-control" name="nisn" value="<?php echo $d->nisn ?>"  maxlength="15" disabled><p>Tidak Tahu NISN anda? cek <a href="https://nisn.data.kemdikbud.go.id/page/data" target="_blank">DISINI</a></p>
						</div>
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="nama_ibu" value="<?php echo $d->nama_ibu ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">Nama Ayah : </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="nama_ayah" value="<?php echo $d->nama_ayah ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">Tinggi Badan : </label>
						<div class="col-sm-8">
							<input type="number" class="form-control" name="tinggi_badan" value="<?php echo $d->tinggi_badan ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">Berat Badan : </label>
						<div class="col-sm-8">
							<input type="number" class="form-control" name="berat_badan" value="<?php echo $d->berat_badan ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">Tempat Lahir : </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="tempat_lahir" value="<?php echo $d->tempat_lahir ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">Tanggal Lahir : </label>
						<div class="col-sm-8">
							<input type="date" class="form-control" name="tanggal_lahir" value="<?php echo $d->tanggal_lahir ?>" disabled >
						</div>
						<label class="col-sm-3 col-form-label">No. HP : </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="hp" value="<?php echo $d->hp ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">No. Telpon :</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="telpon" value="<?php echo $d->telpon ?>" disabled >
						</div>
						<div class="col-sm-4">
							<label>Warga Negara : </label>
						</div>
						 <div class="col-sm-8">
							<select name="warga_negara" id="wn" class="form-control" disabled >
					...
					<div class="col-sm-6">
						<label class="col-sm-4 col-form-label">Kota / Kabupaten : </label>
						 <div class="col-sm-8">
							<select name="kotakab" id="kotakab" class="form-control" disabled > 
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" name="kode_pos" value="<?php echo $d->kodepos ?>" disabled >
						</div>
						<label class="col-sm-3 col-form-label">Kelurahan : </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="kelurahan" value="<?php echo $d->kelurahan ?>" disabled >
						</div>
						<label class="col-sm-4 col-form-label">Alamat : </label>
						<div class="col-sm-8">
							<textarea class="form-control" name="alamat" style="resize: none;" disabled ><?php echo $d->alamat ?></textarea>
						</div>
						...
						<div class="col-sm-8">
							<div class="row">
								<div class="col-sm-6">
									<input type="text" class="form-control" name="rt" value="<?php echo $d->rt ?>" disabled >
								</div>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="rw" value="<?php echo $d->rw ?>" disabled >
								</div>
							</div>
						</div>
						<label class="col-sm-3 col-form-label">Sekolah Asal :</label>
						 <div class="col-sm-8">
						 <select name="asal_sekolah" id="asal_sekolah" class="form-control js-example-basic-single" disabled>
						 ...
						 <div <?php if($d->jalur_pendaftaran != 2){ echo 'hidden=""'; }else{ echo '';}?>>
							...
							<div class="col-sm-8">
								<select name="kerjasama" class="form-control" readonly="" disabled>
							...
							<div <?php if($d->is_kerjasama != 1){ echo 'hidden=""'; }else{ echo '';}?>>
								<label class="col-sm-4 col-form-label">Jenis Kerjasama :</label>
								<div class="col-sm-8">
									<select name="mou" class="form-control" readonly="" disabled>
						...
						<label class="col-sm-6 col-form-label">Pilih Jenis Pendaftaran :</label>
						 <div class="col-sm-8">
							<select name="pendaftaran" class="form-control" readonly="" disabled>
						...
						<label class="col-sm-8 col-form-label">Gelombang Pendaftaran : </label>
						 <div class="col-sm-8">
							<select name="gelombang" id="gelombang" class="form-control" readonly="" disabled>
						...
						<div <?php if ($d->jalur_pendaftaran != 1) { echo 'hidden=""';}else{ echo '';}?>>
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="pmdp" value="<?php echo $d->peringkat_pmdp ?>" disabled >
							</div>
						</div>
						<label class="col-sm-6 col-form-label">Pilih Program Studi 1 : </label>
						 <div class="col-sm-8">
							<select name="pilihan1" class="form-control" disabled >
						...
						<label class="col-sm-6 col-form-label">Pilih Program Studi 2 : </label>
						 <div class="col-sm-8">
							<select name="pilihan2" class="form-control" disabled >
						...
						<div class="col-sm-8">
							<select name="info_pmb" class="form-control" disabled >
