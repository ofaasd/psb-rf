...
<table width="100%" style="border: 1px solid black; border-collapse: collapse;">
	...
	<tr  style="border: 1px solid black; border-collapse: collapse;">
		...
		<td  style="border: 1px solid black; border-collapse: collapse; font-size:12px;"><center><?php $huruf = 'E'; 
																																		if (is_null($a->nhuruf) || $a->publish_tugas == 0 || $a->publish_uts == 0 || $a->publish_uas == 0 || $a->keuangan == 0 || is_null($a->keuangan) || empty($a->keuangan)) {
                                                                      # code...
                                                                      echo "-";
                                                                    }else{
                                                                      echo $a->nhuruf;
		...
		<td  style="border: 1px solid black; border-collapse: collapse; font-size:12px;"><center><?php 
																																		if (is_null($a->nakhir) || $a->publish_tugas == 0 || $a->publish_uts == 0 || $a->publish_uas == 0 || $a->keuangan == 0 || is_null($a->keuangan) || empty($a->keuangan)) {
                                                                      # code...
                                                                      echo "-";
                                                                    }else{
