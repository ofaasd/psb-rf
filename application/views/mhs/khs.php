                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <b><?php echo $ta; ?> <font color="green">(Aktif)</font> <a href="<?php echo base_url();?>mhs/khs/cetak_khs">Download KHS</a></b>
                                                            ...
                                                            foreach($khs as $a){
                                                              ...
                                                              ?>
                                                                <tr>
                                                                    ...
                                                                    <td><center><?php if (is_null($a->nakhir) || $a->publish_tugas == 0 || $a->publish_uts == 0 || $a->publish_uas == 0 || $a->keuangan == 0 || is_null($a->keuangan) || empty($a->keuangan)) {
                                                                      # code...
                                                                      echo "- | ".$v_uas;
                                                                    }else{
                                                                      echo $a->nakhir.' | '.$v_uas;
                                                                      } ?></center></td>
                                                                    <td><center><?php if (is_null($a->nhuruf) || $a->publish_tugas == 0 || $a->publish_uts == 0 || $a->publish_uas == 0 || $a->keuangan == 0 || is_null($a->keuangan) || empty($a->keuangan)) {
                                                                      # code...
                                                                      echo $nhuruf = "- | ".$v_uas;
                                                                    }else{
                                                        ...
                                                        foreach($ta_history as $h){?>
                                                          ...
                                                          <?php 
                                                                ...
                                                                echo "<b>".$h->awal." - ".$h->akhir." ".$jenis." <a href='". base_url('mhs/khs/cetak_khs_history/'.$ta_id.'-'.$nim) ."'>Download KHS</a></b>";
